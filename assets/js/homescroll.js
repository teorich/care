...
$(document).ready(function() {
    ...
    }), mobileAndTabletcheck() || $("body").on("click", ".how", function(e) {
        $(".android.phone-sms a.download").trigger("click"), 6 != $("body").attr("show-frame") && (e.preventDefault(), $("body").attr("show-frame", 3))
